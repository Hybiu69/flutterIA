...
class senai extends StatelessWidget {
  const senai({super.key});
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const ChatScreen(title: 'SENAI AI'),
    );
  }
}
    ...
    return Scaffold(
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            const Text(
              'To use the Gemini API, you\'ill need an API key.'
                  'If you don\'t already have one,'
                  'create a key in Google AI Studio.',
            ),
            const SizedBox(height: 8),
            Link(
              uri: Uri.https('makersuit.google.com', '/app/apikey'),
              target: LinkTarget.blank,
              builder: (context, followLink) =>
                  TextButton(
                    onPressed: followLink,
                    child: const Text('Informe API key'),
                  ),
            ),
            const SizedBox(height: 8),
            Row(
              ...
              children: [
                Expanded(
                  child: TextField(
                    ...
                    decoration:
                    textFieldDecoration(context, 'Escreva o prompt...'),
                    controller: _textController,
